<template v-loading.fullscreen.lock="$store.state.global.ajax_loading">
    <div class="home">
        ...
        <div   class="dash">
        	<div>
        		<el-row>
				  <el-col :span="9" :push="15">
				  	<div class="grid-content bg-purple">
				  		<el-button  size='mini' :plain="true"  type="info" @click = "addDashButton"><i class="el-icon-plus el-icon--left" ></i> 添加图表看板</el-button>
						<el-button  size='mini' :plain="true"  type="info" @click ="formatLayout"><i class="el-icon-menu el-icon--left"></i>版式布局</el-button>
				  	</div>
				  </el-col>
				</el-row>
        	</div>
